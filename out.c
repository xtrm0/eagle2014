...
# 1 "<command-line>" 2
# 1 "code/cockpit.c"
# 1 "code/../include/cockpit.h" 1


# 1 "code/../include/../include/spaceship.h" 1


# 1 "code/../include/../include/../include/defines.h" 1
...
# 4 "code/../include/../include/../include/defines.h" 2
...
# 5 "code/../include/../include/../include/defines.h" 2
# 4 "code/../include/../include/spaceship.h" 2
# 1 "code/../include/../include/../include/geometry.h" 1


# 1 "code/../include/../include/../include/../include/defines.h" 1
# 4 "code/../include/../include/../include/geometry.h" 2
# 1 "/usr/include/errno.h" 1 3 4
# 5 "code/../include/../include/../include/geometry.h" 2
...
# 6 "code/../include/../include/../include/geometry.h" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.9/include/float.h" 1 3 4
# 7 "code/../include/../include/../include/geometry.h" 2
...
# 9 "code/../include/../include/../include/geometry.h" 2
...
# 10 "code/../include/../include/../include/geometry.h" 2
...
# 11 "code/../include/../include/../include/geometry.h" 2
# 22 "code/../include/../include/../include/geometry.h"
...
# 46 "code/../include/../include/../include/geometry.h"
...
# 62 "code/../include/../include/../include/geometry.h"
...
# 106 "code/../include/../include/../include/geometry.h"
polygon * poly();
...
# 182 "code/../include/../include/../include/geometry.h"
...
# 5 "code/../include/../include/spaceship.h" 2
# 1 "code/../include/../include/../include/view.h" 1


# 1 "/usr/include/errno.h" 1 3 4
# 4 "code/../include/../include/../include/view.h" 2



# 1 "/usr/include/g2.h" 1 3 4
# 93 "/usr/include/g2.h" 3 4
enum QPshape {
    QPrect,
    QPcirc
};
...
# 176 "/usr/include/g2.h" 3 4
 ...
 void g2_get_pd_handles(int pd, void *handles[32]);
# 8 "code/../include/../include/../include/view.h" 2
# 1 "/usr/include/g2_X11.h" 1 3 4
# 28 "/usr/include/g2_X11.h" 3 4
...
# 9 "code/../include/../include/../include/view.h" 2
# 1 "code/../include/../include/../include/../include/geometry.h" 1
# 10 "code/../include/../include/../include/view.h" 2
# 26 "code/../include/../include/../include/view.h"
typedef struct view {
  int W, H;
  int id, dev;
  char * name;
...
# 6 "code/../include/../include/spaceship.h" 2
# 1 "code/../include/../include/../include/surface.h" 1



# 1 "code/../include/../include/../include/../include/view.h" 1
# 5 "code/../include/../include/../include/surface.h" 2
# 1 "code/../include/../include/../include/../include/list.h" 1




# 1 "code/../include/../include/../include/../include/defines.h" 1
# 6 "code/../include/../include/../include/../include/list.h" 2
...
# 6 "code/../include/../include/../include/surface.h" 2
...
void sfc_add_lp(surface * s, char name[30]);
...
# 7 "code/../include/../include/spaceship.h" 2
# 1 "/usr/include/errno.h" 1 3 4
# 8 "code/../include/../include/spaceship.h" 2
# 44 "code/../include/../include/spaceship.h"
...
# 121 "code/../include/../include/spaceship.h"
int spc_unsafe_landing(spaceship * s);
# 4 "code/../include/cockpit.h" 2
# 1 "code/../include/../include/button.h" 1
...
# 5 "code/../include/cockpit.h" 2
# 1 "code/../include/../include/gtimer.h" 1



# 1 "/usr/include/errno.h" 1 3 4
# 5 "code/../include/../include/gtimer.h" 2
...
# 7 "code/../include/../include/gtimer.h" 2
# 25 "code/../include/../include/gtimer.h"
...
# 26 "code/../include/../include/gtimer.h" 2
# 46 "code/../include/../include/gtimer.h"
...
# 6 "code/../include/cockpit.h" 2
# 37 "code/../include/cockpit.h"
...
void draw_gui(spaceship * s, camera2d * c, view * v, int res) {
  ...
  g2_string(v->id, 50, v->H - 0 - 1*(20 + 20), "Atitude:");
  g2_string(v->id, 50, v->H - 0 - 2*(20 + 20), "Altitude:");
  g2_string(v->id, 50, v->H - 0 - 3*(20 + 20), "Distancia Horizontal:");
  g2_string(v->id, 50, v->H - 0 - 4*(20 + 20), "Velocidade x:");
  g2_string(v->id, 50, v->H - 0 - 5*(20 + 20), "Velocidade z:");
  g2_string(v->id, 50, v->H - 0 - 6*(20 + 20), "Combustivel:");
  g2_string(v->id, 50, v->H - 0 - 7*(20 + 20), "Aterragem:");


  g2_string(v->id, 400, v->H - 0 - 1*(20 + 20), "F :");
  g2_string(v->id, 400, v->H - 0 - 2*(20 + 20), "F :");

  g2_string(v->id, 400 + 8, v->H - 0 - 1*(20 + 20) - 8, "r");
  g2_string(v->id, 400 + 8, v->H - 0 - 2*(20 + 20) - 8, "m");
  ...
  sprintf(str, "%5.2f" " \xb0", s->rot*180.0/(3.1415926535));
  g2_string(v->id, 50 + 180 + 20, v->H - 0 - 1*(20 + 20), str);
  sprintf(str, "%5.2f" " m", s->z);
  g2_string(v->id, 50 + 180 + 20, v->H - 0 - 2*(20 + 20), str);
  sprintf(str, "%5.2f" " m", s->x);
  g2_string(v->id, 50 + 180 + 20, v->H - 0 - 3*(20 + 20), str);
  sprintf(str, "%5.2f" " m/s", s->vx);
  g2_string(v->id, 50 + 180 + 20, v->H - 0 - 4*(20 + 20), str);
  sprintf(str, "%5.2f" " m/s", s->vz);
  g2_string(v->id, 50 + 180 + 20, v->H - 0 - 5*(20 + 20), str);
  sprintf(str, "%5.2f" " kg", s->mass_comb);
  g2_string(v->id, 50 + 180 + 20, v->H - 0 - 6*(20 + 20), str);
  sprintf(str, "%3.2f" " %%", s->fr * 100);
  g2_string(v->id, 400 + 30, v->H - 0 - 1*(20 + 20), str);
  sprintf(str, "%3.2f" " %%", s->ft * 100);
  g2_string(v->id, 400 + 30, v->H - 0 - 2*(20 + 20), str);
  ...
  g2_string(v->id, 50 + 180 + 20, v->H - 0 - 7*(20 + 20), str);
}
...
int modo_cockpit(spaceship * s, unsigned int mode) {
  ...
  g2_set_font_size(v->id, 20);

  if(((s->initialized) & 1)==0) {
  ...
  if (mode & 2) {
    ...
    btn_more_r = btn_init(400 + 160, v->H - 0 - 1.25*(20 + 20), 30, 30, 8, 10, 0, ">", 20.0, 1);
    btn_less_r = btn_init(400 + 120, v->H - 0 - 1.25*(20 + 20), 30, 30, 8, 10, 0, "<", 20.0, 1);
    btn_more_t = btn_init(400 + 120, v->H - 0 - 2.25*(20 + 20), 30, 30, 10, 10, 0, "+", 20.0, 1);
    btn_less_t = btn_init(400 + 160, v->H - 0 - 2.25*(20 + 20), 30, 30, 12, 10, 0, "-", 20.0, 1);
    btn_pause = btn_init(400, 110, 90, 30, 20, 8, 0, "Pause", 20.0, 1);
    btn_play = btn_init(400, 110, 90, 30, 20, 8, 0, "Start", 20.0, 1);
    btn_exit = btn_init(400, 110, 90, 30, 20, 8, 0, "Sair" , 20.0, 1);
  } else if (mode & 1) {
    btn_more_r = btn_init(400 + 160, v->H - 0 - 1.25*(20 + 20), 30, 30, 8, 10, 0, ">", 20.0, 1);
    btn_less_r = btn_init(400 + 120, v->H - 0 - 1.25*(20 + 20), 30, 30, 8, 10, 0, "<", 20.0, 1);
    btn_more_t = btn_init(400 + 120, v->H - 0 - 2.25*(20 + 20), 30, 30, 10, 10, 0, "+", 20.0, 1);
  ...
  if (mouse_x == ((void *)0)) { fprintf(stderr, "(3x23) Erro detetado: Memory Access Error!"); exit(12);};
  if (mouse_y == ((void *)0)) { fprintf(stderr, "(3x23) Erro detetado: Memory Access Error!"); exit(12);};
  if (mouse_button == ((void *)0)) { fprintf(stderr, "(3x23) Erro detetado: Memory Access Error!"); exit(12);};

  teemo = gtimer_init(60.0);
  while (1) {
